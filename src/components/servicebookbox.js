...
const servicebookbox = ({ image, text, text1, id }) => {
    ...
    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
      <TouchableOpacity style={styles.bookno} onPress={() => navigation.push('BookingDetails',{ id:id })}>
        <View style={styles.boxbox}>
          ...
          <Text style={styles.booking}> You are booked by {text} on {text1}. The Booking ID is {id} </Text>
